...
<div style="background:#2c2c2c;color:white;padding:20px 40px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;">
  ...
  const s = {
    ...
    input: { width: "100%", padding: "9px 11px", border: "1px solid #e0e0e0", borderRadius: 7, fontSize: 14, boxSizing: "border-box", marginBottom: 10, fontFamily: FONT },
    textarea: { width: "100%", padding: "9px 11px", border: "1px solid #e0e0e0", borderRadius: 7, fontSize: 13, boxSizing: "border-box", marginBottom: 6, minHeight: 80, resize: "vertical", fontFamily: FONT },
    btn: { padding: "10px 18px", borderRadius: 8, border: "none", cursor: "pointer", fontSize: 14, fontWeight: 700, fontFamily: FONT },
